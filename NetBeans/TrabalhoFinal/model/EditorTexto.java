...
public class EditorTexto { 
    ...
    private java.util.List<String> formatações;
    ...
    //public EditorTexto(File arquivoAtual) {
        //this.arquivoAtual = arquivoAtual;
        //arquivoBinario = new ArquivoBinario();
        //formatações = new ArrayList<>();
    }

    public java.util.List<String> getFormatações() {
        return formatações;
    }
    ...
    public void abrirArquivo() {
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Serializacao s = arquivoBinario.abrir(caminho);
                editorPane.setText(s.getTexto());
                formatações = s.getFormatações();
        ...
        if (arquivoAtual == null) {
            ...
            if (resultado == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    Serializacao s = new Serializacao(editorPane.getText(), formatações);
                    arquivoBinario.salvar(arquivoSelecionado.getAbsolutePath(), s);
    ...
    public void aplicarSublinhado() {
        StyledDocument doc = editorPane.getStyledDocument();
        SimpleAttributeSet atributos = new SimpleAttributeSet();
        StyleConstants.setUnderline(atributos, true);
        doc.setCharacterAttributes(editorPane.getSelectionStart(), editorPane.getSelectionEnd() - editorPane.getSelectionStart(), atributos, false);
        formatações.add("Sublinhado");
    }

    public void aplicarFontePadrao() {
        StyledDocument doc = editorPane.getStyledDocument();
        SimpleAttributeSet atributos = new SimpleAttributeSet();
        ...
        doc.setCharacterAttributes(editorPane.getSelectionStart(), editorPane.getSelectionEnd() - editorPane.getSelectionStart(), atributos, false);
        formatações.add("Fonte padrão");
    }

    public void alinharTexto(int alinhamento) {
        StyledDocument doc = editorPane.getStyledDocument();
        SimpleAttributeSet atributos = new SimpleAttributeSet();
    ...
    public void alternarModoNoturno(ActionEvent e) {
